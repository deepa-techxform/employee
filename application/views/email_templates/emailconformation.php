...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #26cffe; height: 100%; margin: 0; padding: 0; width: 100%">
  <center>
 ...
 100%; background-color: #26cffe; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
      <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #26cffe;
...
#1bc92a; font-weight: normal; text-decoration: none" target="_blank" title="">
                                  <a class="" href="https://www.lingoapp.com/" style="mso-line-height-rule:
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #1bc92a; font-weight: normal; text-decoration: none" target="_blank" title="">
                                    <img align="center" alt="Forgot your password?" class="mcnImage" src="<?php echo base_url();?>uploads/logo/pklogo.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
 text-decoration: none; vertical-align: bottom; max-width:1200px; padding-bottom:
 0; display: inline !important; vertical-align: bottom;" width="100"></img>
                                  </a>
                                </a>
                              </td>
                            </tr>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Thanks for signing up.please verify your email address by clicking the button below.
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                        <a class="mcnButton " href="<?php echo base_url();?>users/activate/<?= $id ?>" style="mso-line-height-rule: exactly;
 ...
 invitation">Verify Your Email Address and Log in</a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
